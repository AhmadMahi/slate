...
enum _Pane { push, mirrors, storage }
            ...
            builder: (context, _) => SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const Divider(height: 22),
                  // "Sync with git" (per-notebook op-log history) was removed
                  // here: the central "Sync all notebooks" in Settings backs
                  // everything up, so the only per-notebook GitHub control left
                  // is pushing page PDFs.
                  _Disclosure(
...
///
/// This does NOT sync the notebook's files (that is what the central "Sync all
/// notebooks" in Settings is for). It only records which repo a page's PDFs
/// should be pushed to (Export → Push this page to the repo). The repo stays
/// empty until a page is pushed.
